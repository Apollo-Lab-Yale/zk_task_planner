#!/usr/bin/env python3
"""
Test script for using Intel Realsense camera with Ultralytics YOLO-World model
...
def main():
    ...
    parser = argparse.ArgumentParser(description='Test Realsense camera with YOLO-World')
    ...
    try:
        ...
        print(f"Loaded YOLO-World model: {args.model}")
    ...
    cv2.namedWindow('YOLO-World Detection', cv2.WINDOW_AUTOSIZE)
    ...
    try:
        while True:
            ...
            class_text = f"Detecting: {', '.join(current_classes)}"
